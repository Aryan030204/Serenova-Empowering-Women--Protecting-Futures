    ...
    <div className="flex bg-purple-400 lg:w-full lg:h-[40vh] md:h-[17rem]">
      <div className="flex flex-col w-[60%]">
        <div className="w-full">
          <h1 className="text-white font-bold lg:text-7xl ml-[2rem] my-2 md:text-3xl md:mt-[1rem] drop-shadow-[0px_0px_1px_black]">
      ...
      <div className="flex w-[40%] gap-2">
        <img
          src={hero2}
          className="relative lg:top-[10rem] lg:left-[7rem] w-[32rem] h-[13rem] md:left-[-4rem] md:top-[5.5rem]"
        />
        <img
          src={hero1}
          className="relative lg:bottom-[7.5rem] lg:h-[32rem] md:h-[22rem] lg:right-[1rem] md:bottom-[3rem] md:right-[8.5rem]"
        />
      </div>
    </div>
  );
